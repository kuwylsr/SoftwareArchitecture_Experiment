...
public class MovieGraphTest extends ConcreteGraphTest {
  ...
  public void create_MovieGraph() {
    ...
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Actor_not_full_nature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Director_not_full_nature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_EdgeType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_EdgeType_not_match.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Movies/re_read/data_Movie_Edge_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Edge_weight_error.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Movies/re_read/data_Movie_Graph.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_GraphName_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_GraphType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_GraphType_not_match.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Movie_not_full_nature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_VertexType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_VertexType_not_match.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Vertex_in_Edge_not_have.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Vertex_not_full_exnature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Movies/re_read/data_Movie_Vertex_in_H_not_have.txt"));


    graph = graph
        .create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_Edge_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        ...
        + "The edge:\n" + "No||SRFD:<FrankDarabont,TheShawshankRedemption>"
        + "<TheShawshankRedemption,FrankDarabont>(-1.0)\n"
        ...
        + "No||SRTR:<TheShawshankRedemption,MorganFreeman>"
        + "<MorganFreeman,TheShawshankRedemption>(2.0)\n"
        ...
        graph.toString());
    graph = graph
        .create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_Edge_Loop_error.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        + " <TimRobbins, Actor, <60, M>>\n" + " <TheGreenMile, Movie, <1999, USA, 8.500000>>\n"
        ...
        + "No||GMFD:<FrankDarabont,TheGreenMile><TheGreenMile,FrankDarabont>(-1.0)\n"
        + "H||ActorsInSR:<FrankDarabont,TimRobbins,MorganFreeman,>\n"
        + "No||SRTR:<TheShawshankRedemption,"
        + "MorganFreeman><MorganFreeman,TheShawshankRedemption>(2.0)\n"
        + "No||GMTH:<TomHanks,TheGreenMile><TheGreenMile,TomHanks>(1.0)\n"
        + "No||SRMF:<TheShawshankRedemption,TimRobbins><TimRobbins,TheShawshankRedemption>(1.0)\n",
        graph.toString());
    graph = graph
        .create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_Edge_point_error.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        + " <TimRobbins, Actor, <60, M>>\n" + " <TheGreenMile, Movie, <1999, USA, 8.500000>>\n"
        ...
        graph.toString());
    graph = graph
        .create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_Vertex_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        ...
        graph.toString());
    graph =
        graph.create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_H_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        + " <TimRobbins, Actor, <60, M>>\n" + " <TheGreenMile, Movie, <1999, USA, 8.500000>>\n"
        ...
        graph.toString());
    graph = graph
        .create_MovieGraph("test/graph/exception_Movies/repair/data_Movie_Edge_have_mutiEdge.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        + " <TimRobbins, Actor, <60, M>>\n" + " <TheGreenMile, Movie, <1999, USA, 8.500000>>\n"
        ...
        + "No||SRMF:<TheShawshankRedemption,TimRobbins><TimRobbins,TheShawshankRedemption>(1.0)\n",
        graph.toString());
    graph = graph.create_MovieGraph(
        "test/graph/exception_Movies/repair/data_Movie_Edge_begin_end_error.txt");
    assertEquals("The vertices:\n" + " <TomHanks, Actor, <62, M>>\n"
        + " <FrankDarabont, Director, <59, M>>\n"
        + " <TheShawshankRedemption, Movie, <1994, USA, 9.300000>>\n"
        + " <TimRobbins, Actor, <60, M>>\n" + " <TheGreenMile, Movie, <1999, USA, 8.500000>>\n"
  ...
  public void getandset_EdgeType() {
    ...
    assertEquals("MovieActorRelation MovieDirectorRelation SameMovieHyperEdge",
        graph.get_EdgeType());
