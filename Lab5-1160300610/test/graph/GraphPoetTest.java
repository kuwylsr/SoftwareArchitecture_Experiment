...
public class GraphPoetTest extends ConcreteGraphTest {
  ...
  public void create_GraphPoet() {
    ...
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_Edge_not_full.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_Edge_point_error.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_Edge_weight_error.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_EdgeType_not_full.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_EdgeType_not_match.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_GraphName_not_full.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Poets/re_read/data_Poet_GraphType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Poets/re_read/data_Poet_GraphType_not_match.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Poets/re_read/data_Poet_Vertex_in_Edge_not_have.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Poets/re_read/data_Poet_Vertex_not_full_exnature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Poets/re_read/data_Poet_VertexType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Poets/re_read/data_Poet_VertexType_not_match.txt"));



    graph = graph
        .create_GraphPoet("test/graph/exception_Poets/repair/data_Poet_Edge_have_HyperEdge.txt");
    assertEquals("The vertices:\n" + " <666, Word>\n" + " <999, Word>\n" + " <888, Word>\n" + "\n"
        + "_________________________________________________________________\n" + "\n"
        + "The edge:\n" + "Yes||hhh:<888,999>(10.0)\n" + "Yes||ccc:<888,888>(10.0)\n"
        + "Yes||ggg:<666,888>(100.0)\n", graph.toString());
    graph = graph
        .create_GraphPoet("test/graph/exception_Poets/repair/data_Poet_Edge_have_multiEdge.txt");
    assertEquals(
        "The vertices:\n" + " <666, Word>\n" + " <999, Word>\n" + " <888, Word>\n" + "\n"
            + "_________________________________________________________________\n" + "\n"
            + "The edge:\n" + "Yes||hhh:<888,999>(10.0)\n" + "Yes||ggg:<666,888>(100.0)\n",
        graph.toString());
    graph =
        graph.create_GraphPoet("test/graph/exception_Poets/repair/data_Poet_Edge_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <666, Word>\n" + " <999, Word>\n" + " <888, Word>\n" + "\n"
        + "_________________________________________________________________\n" + "\n"
        + "The edge:\n" + "Yes||hhh:<888,999>(10.0)\n" + "Yes||ccc:<888,888>(10.0)\n"
        + "Yes||ggg:<666,888>(100.0)\n" + "Yes||ccc1:<888,888>(10.0)\n", graph.toString());
    graph = graph
        .create_GraphPoet("test/graph/exception_Poets/repair/data_Poet_Vertex_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <666, Word>\n" + " <6662, Word>\n" + " <6661, Word>\n" + "\n"
        + "_________________________________________________________________\n" + "\n"
