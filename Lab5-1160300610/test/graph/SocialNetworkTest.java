...
public class SocialNetworkTest extends ConcreteGraphTest {
  ...
  public void create_SocialNetwork() {
    ...
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_EdgeType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_EdgeType_not_match.txt"));
    assertEquals(true,
        re_read_file(graph, "test/graph/exception_Socials/re_read/data_Social_Edge_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_Edge_point_error.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_Edge_weight_error.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_GraphName_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_GraphType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_GraphType_not_match.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_VertexType_not_full.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_VertexType_not_match.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_Vertex_in_Edge_not_have.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_Vertex_not_full_exnature.txt"));
    assertEquals(true, re_read_file(graph,
        "test/graph/exception_Socials/re_read/data_Social_Vertex_Person_not_full_nature.txt"));



    graph = graph.create_SocialNetwork(
        "test/graph/exception_Socials/repair/data_Social_Edge_have_HyperEdge.txt");
    ...
    graph = graph.create_SocialNetwork(
        "test/graph/exception_Socials/repair/data_Social_Edge_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <Kevin, Person, <34, M>>（0.000000）\n"
        + " <Edith, Person, <25, M>>（0.000000）\n" + " <Sophia, Person, <21, F>>（0.000000）\n"
        + " <Emma, Person, <19, F>>（0.000000）\n" + " <Vera, Person, <18, F>>（0.000000）\n"
        + " <Evelyn, Person, <32, M>>（0.000000）\n" + " <Rose, Person, <31, F>>（0.000000）\n"
    ...
    graph =
        graph.create_SocialNetwork("test/graph/exception_Socials/repair/data_Social_Edge_Loop.txt");
    assertEquals("The vertices:\n" + " <Kevin, Person, <34, M>>（0.000000）\n"
        + " <Edith, Person, <25, M>>（0.000000）\n" + " <Sophia, Person, <21, F>>（0.000000）\n"
        + " <Emma, Person, <19, F>>（0.000000）\n" + " <Vera, Person, <18, F>>（0.000000）\n"
        + " <Evelyn, Person, <32, M>>（0.000000）\n" + " <Rose, Person, <31, F>>（0.000000）\n"
        ...
        + "Yes||SophiaCommentEmma:<Sophia,Emma>(0.004964726239798198)\n", graph.toString());
    graph = graph.create_SocialNetwork(
        "test/graph/exception_Socials/repair/data_Social_Vertex_Label_repeat.txt");
    assertEquals("The vertices:\n" + " <Kevin, Person, <34, M>>（0.000000）\n"
        + " <Edith, Person, <25, M>>（0.000000）\n" + " <Emma1, Word>\n"
        + " <Sophia, Person, <21, F>>（0.000000）\n" + " <Emma, Person, <19, F>>（0.000000）\n"
        + " <Vera, Person, <18, F>>（0.000000）\n" + " <Evelyn, Person, <32, M>>（0.000000）\n"
