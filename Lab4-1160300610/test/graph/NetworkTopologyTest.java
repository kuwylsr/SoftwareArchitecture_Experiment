...
public class NetworkTopologyTest extends ConcreteGraphTest{
    ...
    public void create_NetworkTopology() {
    	...
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Computer_not_full_nature.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_EdgeType_not_full.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_EdgeType_not_match.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Edge_not_full.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Edge_point_error.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_GraphName_not_full.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_GraphType_not_full.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_GraphType_not_match.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Router_not_full_nature.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Server_not_full_nature.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_VertexType_not_full.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_VertexType_not_match.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Vertex_in_Edge_not_have.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_Vertex_not_full_exnature.txt"));
    	assertEquals(true, re_read_file(graph,"test/graph/exception_Topologys/re_read/data_Topology_WirelessRouter_not_full_nature.txt"));

    	
    	
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Edge_begin_end_error.txt");
    	assertEquals("The vertices:\n" + 
    			...
    			, graph.toString());
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Edge_have_HyperEdge.txt");
    	assertEquals("The vertices:\n" + 
    			" <Server1, Server, <192.168.1.2>>\n" + 
    			" <Router1, Router, <192.168.1.1>>\n" + 
    			" <Computer1, Computer, <192.168.1.101>>\n" + 
    			...
    			"No||C1S1:<Server1,Computer1><Computer1,Server1>(10.0)\n"
    			, graph.toString());
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Edge_have_multiEdge.txt");
    	assertEquals("The vertices:\n" + 
    			" <Server1, Server, <192.168.1.2>>\n" + 
    			" <Router1, Router, <192.168.1.1>>\n" + 
    			" <Computer1, Computer, <192.168.1.101>>\n" +  
    			...
    			"No||R1S1:<Server1,Router1><Router1,Server1>(100.0)\n"
    			, graph.toString());
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Edge_Label_repeat.txt");
    	assertEquals("The vertices:\n" + 
    			" <Server1, Server, <192.168.1.2>>\n" + 
    			" <Router1, Router, <192.168.1.1>>\n" + 
    			" <Computer1, Computer, <192.168.1.101>>\n" + 
    			...
    			, graph.toString());
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Edge_Loop_error.txt");
    	assertEquals("The vertices:\n" + 
    			" <Server1, Server, <192.168.1.2>>\n" + 
    			" <Router1, Router, <192.168.1.1>>\n" + 
    			" <Computer1, Computer, <192.168.1.101>>\n" + 
    			...
    			"No||C1S1:<Server1,Computer1><Computer1,Server1>(10.0)\n"
    			, graph.toString());
    	graph=graph.create_NetworkTopology("test/graph/exception_Topologys/repair/data_Topology_Vertex_Label_repeat.txt");
    	assertEquals("The vertices:\n" + 
    			" <Router1, Router, <192.168.1.1>>\n" + 
    			" <Computer1, Computer, <192.168.1.101>>\n" + 
    			" <Computer11, Word>\n" + 
